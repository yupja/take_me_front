...
export const LoginDB = (loginInfo, setModalStr, setNavToggles) => {
  return async function (dispatch) {
    ...
    await axios.post("http://3.37.61.13/api/user/login", loginInfo, {
...
export const addUserDB = (userInfo) => {
  return async function (dispatch) {
    console.log(userInfo);
    await axios.post("http://3.37.61.13/api/user/register", userInfo, {
      "Content-Type": "application/json",
      withCredentials: true,
    })
      .then((response) => {
...
export const idCheckDB = (id, setUserIdAlert) => {
  return async function (dispatch) {
    await axios.post("http://3.37.61.13/api/user/register/checkUsername", { username: id }, {
      "Content-Type": "application/json",
      withCredentials: true,
    })
      .then((res) => {
...
export const emailCheckDB = (email, setUserEmailAlert) => {
  return async function (dispatch) {
    console.log(email);
    await axios.post("http://3.37.61.13/api/user/register/checkEmail", { email: email }, {
      "Content-Type": "application/json",
      withCredentials: true,
    })
      .then((res) => {
...
export const nickCheckDB = (nick, setUserNickAlert) => {
  return async function (dispatch) {
    console.log(nick);
    await axios.post("http://3.37.61.13/api/user/register/checkNickname", { nickname: nick }, {
      "Content-Type": "application/json",
      withCredentials: true,
    })
      .then((res) => {
...
export const findPwDB = (info, setfindPwPop) => {
  return async function (dispatch) {
    console.log(info);
    await axios.post("http://3.37.61.13/api/user/findPassword", info, {
      "Content-Type": "application/json",
      withCredentials: true,
    })
      .then((res) => {
...
export const changePw = (data) => {
  return async function (dispatch) {
    await axios.post("http://3.37.61.13/api/user/changePassword", (data), {
      "Content-Type": "application/json",
      withCredentials: true,
